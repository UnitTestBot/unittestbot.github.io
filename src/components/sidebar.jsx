...
import java from "../pages/docs/java";
...
const Sidebar = ({ className, docsType }) => (
    <>
        <NavTree className={className} docsType={docsType}
                 tree={docsType == DocsType.cFamily ? cFamilyDocs : (docsType == DocsType.java ? javaDocs : null)}/>
    </>
);
